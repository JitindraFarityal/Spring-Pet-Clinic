...
import com.example.jitindra.SpringPetClinic.service.map.OwnerServiceMap;
import com.example.jitindra.SpringPetClinic.service.map.VetServiceMap;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Vet vet2 = new Vet();
        vet2.setId(2L);
        vet2.setFirstName("Oliver");
        vet2.setLastName("Hugh");
